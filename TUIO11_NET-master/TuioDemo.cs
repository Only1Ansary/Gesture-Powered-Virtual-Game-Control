        ...
        if (objectList.Count > 0)
        {
            lock (objectList)
            {
                foreach (TuioObject tobj in objectList.Values)
                {
                    ...
                    {
                        case 1:
                            objectImagePath = Path.Combine(Environment.CurrentDirectory, "png1.png");
                            backgroundImagePath = Path.Combine(Environment.CurrentDirectory, "bg1.jpg");
                            break;
                        case 2:
                            objectImagePath = Path.Combine(Environment.CurrentDirectory, "png2.png");
                            backgroundImagePath = Path.Combine(Environment.CurrentDirectory, "bg2.jpg");
                            break;
                        case 0:
                            objectImagePath = Path.Combine(Environment.CurrentDirectory, "png3.png");
